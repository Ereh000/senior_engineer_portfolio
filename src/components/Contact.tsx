...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-32 bg-[#0B0B0F] border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          >
            <h2 className="text-sm font-medium text-white/40 uppercase tracking-widest mb-4">Get in Touch</h2>
            <h3 className="text-5xl md:text-6xl lg:text-7xl font-semibold tracking-tighter text-balance leading-[1.1] mb-8">
              Let's Build <span className="text-white/40">Scalable</span> Digital Systems.
            </h3>
            <p className="text-lg text-white/60 leading-relaxed max-w-md mb-12">
              Available for freelance opportunities and full-time roles. Reach out to discuss architecture, engineering, or your next big project.
            </p>
            
            <div className="space-y-4">
              <a href="mailto:hello@arifkhan.dev" className="flex items-center gap-4 text-white/70 hover:text-white transition-colors group">
                ...
                <span className="text-lg font-medium tracking-tight">hello@arifkhan.dev</span>
              </a>
              <a href="https://linkedin.com/in/arifkhan" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 text-white/70 hover:text-white transition-colors group">
                <div className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center group-hover:border-white/30 transition-colors">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <span className="text-lg font-medium tracking-tight">LinkedIn</span>
              </a>
            </div>
          </motion.div>
